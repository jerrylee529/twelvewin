...
脚本获取股票基础数据和当日行情，计算 roe、成长估值 value_increase、简单估值
value，以及相对当前价格的估值差 rate/rate_inc。结果按 rate_inc 降序输出到
commondatadef.resultPath 下的 finance_report_*.csv，并通过 csv2html 导出 HTML。
"""
